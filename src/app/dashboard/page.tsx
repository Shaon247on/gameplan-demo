                ...
                >
                  ...
                  <div className="max-w-md space-y-3">
                    ...
                    <p className="text-gray-600 text-lg">
                      I&apos;m your AI assistant, ready to help you create
                      amazing plans and strategies. Whether you&apos;re planning
                      a project, organizing an event, or setting goals, I&apos;m
                  ...
                  <div className="bg-gradient-to-r from-purple-50 to-blue-50 border border-purple-200 rounded-lg p-4 max-w-md">
                    <p className="text-purple-800 text-sm">
                      <strong>💡 Tip:</strong> Start by telling me what
                      you&apos;d like to plan or achieve. I&apos;ll help you
